...
//        }
            ...
            throws Exception
    {
        ...
        for (String lang : providerMap.keySet()) { 
        	System.out.println("Provider-Language: " + lang + " Number of languages: " + providerMap.keySet().size());
            ...
            for (String ngram : ngrams) {
                ...
                System.out.println("Ngram: " + ngram + " Ngram-Size : " + ngramSize + " Frequency: " + frequency);
